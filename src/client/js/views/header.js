      ...
      <div>
        ...
        <ul class='nav'>
          <div class='about-wrapper'>
            <li class='base'><a class='nav-btn scroll' href='#about'><div class="shine">ABOUT</div></a></li>
            <li class='gradient' data-text='ABOUT'><a class='nav-btn scroll' href='#about'></a></li>
          </div>
          <div class='work-wrapper'>
            <li class='base'><a class='nav-btn scroll' href='#work'><div class="shine">WORK</div></a></li>
            <li class='gradient' data-text='WORK'><a class='nav-btn scroll' href='#work'></a></li>
          </div>
          <div class='contact-wrapper'>
            <li class='base'><a class='nav-btn scroll' href='#contact'><div class="shine">CONTACT</div></a></li>
